...
@section('content')
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-md rounded my-6">            
            <form class="w-full my-5 px-5 py-5" action="/users/evento" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="w-full">
                    <label class="block text-gray-500 font-bold md:text-left  md:mb-3 pr-4">Seleccione el evento relacionado</label>
                    <select name="evento" class="bg-transparent  appearance-none outline-none">
                            <option value="0" disabled selected> Seleccione un evento de la lista</option>
