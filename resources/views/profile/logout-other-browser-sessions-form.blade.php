<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puedes desloguearte de todos los otros navegadores en todos tus diferentes dispositivos. Algunas de tus sesiones recientes entán listadas abajo. Sin embargo la lista puede no ser exhaustiva. Si sientes que tu cuenta está comprometida puedes cambiar la contraseña.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor ingrese su contraseña para confirmar que quieres cerrar sesión de todos los otros navegadores en tus dispositivos.') }}
