    ...
    @if(Auth::user()->hasRole('admin'))                                
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="w-full block">
                <a class="verde-lima-bg text-white font-semibold py-2 px-4 border border-gray-400 rounded shadow" href="{{ route('eventos.create') }}"> Insertar nuevo</a>
            </div>
            <div class="w-full block mt-10">
                ...
                <a class="verde-lima-bg text-white font-semibold py-2 px-4 border border-gray-400 rounded shadow" href="{{ route('actividades.index') }}"> Ver listado actividades</a>                
            </div>
            ...
            <div class="bg-white shadow-md rounded my-6">
                <table class="w-full my-5 border-solid border-gray-700">
                    ...
                    <tr class="text-center">
                        ...
                        <td class="py-3">{{ \Str::limit($value->imagen, 20) }}</td>
                        ...
                        <td class="py-3">
                            <form action="{{ route('eventos.destroy',$value->id) }}" method="POST">
                                ...
                                <a class="azul-andes-bg  text-white  py-2 px-4 border border-gray-400 rounded shadow" href="{{ route('eventos.show',$value->id) }}">Mostrar</a>    
                                <a class="verde-lima-bg text-white  py-2 px-4 border border-gray-400 rounded shadow" href="{{ route('eventos.edit',$value->id) }}">Editar</a>   
                                @csrf
                                @method('DELETE')      
            ...
            <div class="bg-white shadow-md rounded my-6 py-6">
                ...
                <a class="azul-andes-bg text-white py-2 px-4 ml-2 border border-white-400 rounded shadow" href="/admin/vmaterial">Videos</a>
            </div>
