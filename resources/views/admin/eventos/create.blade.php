    ...
    @if(Auth::user()->hasRole('admin')) 
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-md">
                <form class="w-full my-5 px-5 py-5" action="{{ route('eventos.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="w-full">
                        <label class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4">Evento nuevo</label>
                    </div>
                    <div class="py-5"></div>
                    <div class="md:flex md:items-center mb-6">                                          
                      <div class="w-full">
                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-100" id="inline-full-name" name="titulo" type="text" placeholder="Ingresar título del evento" value={{ old('titulo') }}>
                      </div>
                    </div>
                    ...
                    <div class="w-full">
                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-100" id="inline-full-name4" name="link" type="text" placeholder="Link con información relevante" value={{ old('link') }}>
                    </div>
