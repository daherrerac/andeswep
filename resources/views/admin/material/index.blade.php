    ...
    @if(Auth::user()->hasRole('admin'))                                
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="w-full block mt-10">
                <a class="verde-lima-bg text-white font-semibold py-2 px-4 border border-gray-400 rounded shadow" href="{{ route('material.create') }}">Nuevo recurso</a>                
            </div>
                    ...
                    <tr class="text-center">
                        ...
                        <td class="py-3">
                            <form action="{{ route('material.destroy',$value->id) }}" method="POST">
                                ...
                                <a class="azul-andes-bg  text-white  py-2 px-4 border border-gray-400 rounded shadow" href="{{ route('material.show',$value->id) }}">Mostrar</a>    
                                <a class="verde-lima-bg text-white  py-2 px-4 border border-gray-400 rounded shadow" href="{{ route('material.edit',$value->id) }}">Editar</a>   
                                @csrf
                                @method('DELETE')      
