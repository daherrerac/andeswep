    ...
    @if(Auth::user()->hasRole('admin'))
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-md">
                <form class="w-full my-5 px-5 py-5" action="{{ url('/admin/materialevento/add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="w-full">
                    ...
                    <small>*Estos documentos están vinculados solo al evento seleccionado</small>
